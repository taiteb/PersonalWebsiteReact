...
export default function Recent() {
    ...
    const wordPressURL = 'https://public-api.wordpress.com/rest/v1.1/sites/taitemcgrady.wordpress.com/posts/?category=Portfolio';

    const wordPressImport = useEffect(() => {
        // Fetches from URL above, which has a filter for my WP site's 'Portfolio' category
    ...
    return (
        <div className="ProjectShowcase">
            ...
            {!content ? <p className="ContentBox RecentPost">Loading...</p> : content.posts.map((post) => {
